...
* `pfam_annotation_secretion_systems/labels.tsv` - labels associated with the Pfam annotation of the secretion system dataset
...
secretion_metadata <- read.delim("single_locus_clusters_renamed.tsv", header=FALSE)
sec_igua=read.delim('supplementary_table_13.tsv', header=TRUE)
labels_2 <- read.delim("pfam_annotation_secretion_systems/labels.tsv", header=FALSE)
