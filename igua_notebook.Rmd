...
benchmark=read.delim(paste0("supplementary_table_4.tsv"))
...
fig3_p <- (
           ((bgcs_hist_GCs + sec_hist_GCs + pro_hist_GCs) +
              plot_layout(axis_titles = "collect_y")) /
           ((bgcs_area_size + sec_area_size + pro_area_size) + plot_layout(axis_titles = "collect_y")) /
           ((bgcs_umap[[1]] + sec_umap[[1]] + pro_umap[[1]]) + plot_layout(axis_titles = "collect_y")) /
           ((bgcs_hist_phyla + sec_hist_phyla + pro_hist_phyla) + plot_layout(axis_titles = "collect_y"))
           ) + 
            plot_layout(heights = c(0.5,0.5,2,0.5)) +
            plot_annotation(tag_levels =
                              list(c('A', 'E', 'I', 'B', 'F', 'J', 'C', 'J', 'K', 'D', 'H', 'L'))) +
            theme(plot.tag = element_text(face = 'bold'))

ggsave("figure3.svg", plot = fig3_p, device = "svg", dpi = 300, units = "px", height = 5950, width = 8050)
